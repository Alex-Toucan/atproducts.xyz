...
$(document).ready(function() {
  if (!getCookie('purecookieDismiss')) {
    $('div#page').append('<div class="cookieConsentContainer bg-secondary-subtle rounded-3" id="cookieConsentContainer"><div class="h4">' + purecookieIcon + '' + purecookieTitle + '</div><div class="my-3"><p>' + purecookieDesc + ' ' + purecookieLink + '</p></div><button class="btn btn-secondary" onclick="purecookieDismiss();">Understood</button></div>');
